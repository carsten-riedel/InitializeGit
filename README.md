...
```
bitsadmin /transfer "RunStub" "https://raw.githubusercontent.com/carsten-riedel/InitializeGit/main/stub.cmd" "%localappdata%\stub.cmd" & Call "%localappdata%\stub.cmd"
```
